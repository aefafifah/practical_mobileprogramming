...
import { Alert, Box, Heading, Text, FormControl, Modal, ModalBackdrop, 
AlertText, Fab, FabLabel, FabIcon, ArrowLeftIcon, ScrollView } from 
"@gluestack-ui/themed"; 
...
backgroundColor="$white" borderRadius={"$md"} mt={"$8"} mx={"$3"} 
px={"$3"} pt={"$2"}> 
...
value={null} onChangeText={() => {}} /> 
          <Input textarea={true} label="Content" width={"$full"} 
height={"$32"} value={null} onChangeText={() => {}} /> 
          <Pilihan label="Status" value={null} selectedValue={null} 
onValueChange={() => {}} /> 
          <Pilihan label="Category" selectedValue={null} datas={null} 
onValueChange={() => {}} /> 
          <Button 
            type="text" 
            title="Update" 
